...
game.load.image("block","assets/plataformblock.png");
game.load.image("bluestar","assets/bluestar.png");
game.load.image("plataformkill","assets/plataformkill.png");
...
textop1life2 = game.add.text(425,34,'Life:',{font:'20px Arial',fill:'black'});
